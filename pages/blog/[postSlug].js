		...
		<>
				...
				>
					...
					<div className="container mx-auto h-full flex flex-col justify-center lg:max-w-4xl">
						...
						<div
							...
							className="relative line-clamp-3 z-10 text-left text-slate-200 text-2xl mt-8 pl-4 border-l-4 border-lime-200"
						/>
					</div>
				</section>
			...
			<div className="container mx-auto lg:max-w-4xl">
				<h3 className="text-xl py-2 my-4 border-l-4 border-l-lime-300 pl-4">
					Bu gönderi için şu ana kadar{' '}
					{commentCount ? commentCount : '0'} yorum yapıldı.
				</h3>
